...
class AuthoringReferenceRegistry(Component):
    ...
    inputs = [MultilineInput(name='registry_json', display_name='승인 업무 어휘·원천 레지스트리 JSON', value='', required=True, info='운영자가 검토한 축약 업무 어휘와 데이터셋별 어댑터·설정·조회 식별자를 포함합니다. 비밀값이나 실행 쿼리는 입력하지 않습니다.')]
