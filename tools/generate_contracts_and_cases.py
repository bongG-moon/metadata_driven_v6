...
def build_envelope_schemas() -> dict[str, dict[str, Any]]:
    ...
    schemas = {
        ...
        "display-options.schema.json": envelope_schema("display-options.schema.json", "display.options.v1", {"profile": string(min_length=1), "include_diagnostics": boolean, "show_result_table": boolean, "table_preview_limit": integer(minimum=1, maximum=20), "show_analysis_evidence": boolean, "show_download_links": boolean, "show_notices": boolean, "show_applied_criteria": boolean, "show_next_questions": boolean, "show_intent_analysis": boolean, "show_data_retrieval": boolean, "show_execution_plan": boolean}, ["profile", "include_diagnostics", "show_result_table", "table_preview_limit", "show_analysis_evidence", "show_download_links", "show_notices", "show_applied_criteria", "show_next_questions", "show_intent_analysis", "show_data_retrieval", "show_execution_plan"]),
        ...
        "gaia-metadata.schema.json": envelope_schema(
            ...
            ["urls", "followup_questions", "trace_id", "usage", "response_sha256", "docs", "images", "knowhows"],
        ),
        "response.schema.json": envelope_schema(
            ...
            ["response_type", "status", "stage_status", "message", "data_mode", "analysis_mode", "request", "intent_plan", "analysis", "clarification", "data", "data_refs", "answer_sections", "state", "trace", "response_sha256"],
        ),
